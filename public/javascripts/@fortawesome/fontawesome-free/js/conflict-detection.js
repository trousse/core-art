...
(function (global, factory) {
  ...
  function conflictDetection() {
    ...
    if (testCount === 0) {
      ...
      console.info("We'll wait about ".concat(Math.round(WINDOW.FontAwesomeDetection.timeout / 10) / 100, " seconds while testing these and<br>") + "then up to another ".concat(Math.round(WINDOW.FontAwesomeDetection.resultsCollectionMaxWait / 10) / 100, " to allow the browser time<br>") + "to accumulate the results. But we'll probably be outta here way before then.\n\n");
